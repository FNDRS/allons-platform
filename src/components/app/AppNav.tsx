...
import { markAppShellHydrated } from "@/hooks/useStairsPreload";
...
function NavLinks({
  ...
  return (
    <nav
      ...
      className="relative hidden min-w-0 items-center justify-center gap-0.5 md:flex"
    >
