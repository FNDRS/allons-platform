...
/**
 * Every text field on the site is the Skiper smooth-caret input. `className`
 * still targets the box, as it did when this rendered a bare `<input>`.
 */
export function Input({
  className = "",
  ...rest
}: InputHTMLAttributes<HTMLInputElement>) {
  return <SmoothInput {...rest} wrapperClassName={className} />;
}
